...
type NavigationVariant = "tabs" | "dropdown";

export function Dashboard(): React.ReactElement {
  const [activePage, setActivePage] = useState(1);
  const [navigationVariant, setNavigationVariant] = useState<NavigationVariant>("dropdown");
  ...
  const renderPage1 = () => {
    ...
    return (
      ...
      {/* ✅ NEW CARD 1: Revenue vs Target (Bar + Line) */}
      ...
      {/* ✅ NEW CARD 2: Cost Breakdown & Profit Margin (Stacked Bar + Line) */}
      <Card className="lg:col-span-2" data-chart-card>
        <CardHeader>
          <CardTitle>Cost Structure & Profitability</CardTitle>
          <CardDescription>Fixed and variable costs (stacked) with profit margin trend (line)</CardDescription>
        </CardHeader>
        <CardContent>
          <ChartVisualization
            chartType="stacked-bar-line"
            data={[
              { month: "Jan", fixedCost: 45000, varCost: 62000, profitMargin: 26 },
              { month: "Feb", fixedCost: 45000, varCost: 71000, profitMargin: 28 },
              { month: "Mar", fixedCost: 45000, varCost: 68000, profitMargin: 28 },
              { month: "Apr", fixedCost: 46000, varCost: 74000, profitMargin: 30 },
              { month: "May", fixedCost: 46000, varCost: 83000, profitMargin: 32 },
              { month: "Jun", fixedCost: 47000, varCost: 87000, profitMargin: 31 },
              { month: "Jul", fixedCost: 47000, varCost: 82000, profitMargin: 45 },
              { month: "Aug", fixedCost: 48000, varCost: 91000, profitMargin: 32 },
              { month: "Sep", fixedCost: 48000, varCost: 88000, profitMargin: 9000 },
              { month: "Oct", fixedCost: 49000, varCost: 96000, profitMargin: 10 },
              { month: "Nov", fixedCost: 49000, varCost: 102000, profitMargin: 6000 },
              { month: "Dec", fixedCost: 50000, varCost: 108000, profitMargin: 33 },
            ]}
            xKey="month"
    ...
    <div className="w-full space-y-4">
      ...
      <Card data-navigation-card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          {/* Toggle between tabs and dropdown */}
          <button
            onClick={() => setNavigationVariant(navigationVariant === "tabs" ? "dropdown" : "tabs")}
            className="px-3 py-1.5 text-xs font-medium text-gray-600 bg-gray-100 rounded-md hover:bg-gray-200 transition-colors"
          >
            Switch to {navigationVariant === "tabs" ? "Dropdown" : "Tabs"}
          </button>
        </CardHeader>
        <CardContent>
          {navigationVariant === "tabs" ? (
            ...
            // Dropdown Navigation
            <Select value={activePage.toString()} onValueChange={(value) => setActivePage(Number(value))}>
              <SelectTrigger className="w-full sm:w-[300px]">
                <SelectValue placeholder="Select a page" />
              </SelectTrigger>
              <SelectContent>
                {pages.map((page) => (
                  <SelectItem key={page.number} value={page.number.toString()}>
                    <span className="font-bold">{page.number}.</span> {page.title}
                  </SelectItem>
                ))}
              </SelectContent>
